rondas = [
...

  {
    preguntas: [
      {
        nombre: 'Cual es el sinonimo de rápido',
        respuestas: [
          {nombre: 'Expedito', numero: 5},
          {nombre: 'Presto', numero: 4},
          {nombre: 'Ligero', numero: 3},          
          {nombre: 'Agil', numero: 2},
          {nombre: 'Veloz', numero: 1}       
        ]
      },
      {
        nombre: ' Cual es el sinonimo de feliz',
        respuestas: [
          {nombre: 'Euforico', numero: 5},
          {nombre: 'Jubiliso', numero: 4},
          {nombre: 'Dichoso', numero: 3},
          {nombre: 'Alegre', numero: 2},
          {nombre: 'Contento', numero: 1}      
        ]
      },
      {
        nombre: 'Cual es el sinonimo de grande',
        respuestas: [
          {nombre: 'Ingente', numero: 5},
          {nombre: 'Colosal', numero: 4},
          {nombre: 'Inmenso', numero: 3},
          {nombre: 'Gigante', numero: 2},
          {nombre: 'Enorme', numero: 1} 
        ]
      }
    ] 
  }
